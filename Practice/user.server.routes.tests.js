...
describe('User CRUD tests', function () {
  ...
  it('should be able to register a new user', function (done) {
    ...
    _user.primaryEmail.email = 'register_new_user_@test.com';
    ...
    agent.post('/api/auth/signup')
      ...
      .end(function (signupErr, signupRes) {
        ...
        signupRes.body.primaryEmail.email.should.equal(_user.primaryEmail.email);
      ...
      agent.post('/api/auth/signin')
        ...
        .end(function (signinErr, signinRes) {
          ...
          var userUpdate = {
            ...
            last.lastName: 'admin_update_last',
            roles: ['admin']
          };
          ...
          agent.put('/api/users/' + user._id)
            ...
            .end(function (userInfoErr, userInfoRes) {
              ...
              userInfoRes.body.last.lastName.should.be.equal('admin_update_last');
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.get('/api/users/me')
          ...
          .end(function (err, res) {
            ...
            res.body.primaryEmail.email.should.equal(user.primaryEmail.email);
      ...
      agent.post('/api/auth/signin')
        ...
        .end(function (signinErr, signinRes) {
          ...
          var userUpdate = {
            ...
            last.lastName: 'user_update_last',
          };
          ...
          agent.put('/api/users')
            ...
            .end(function (userInfoErr, userInfoRes) {
              ...
              userInfoRes.body.last.lastName.should.be.equal('user_update_last');
              userInfoRes.body.roles.should.be.instanceof(Array).and.have.lengthOf(1);
  ...
  it('should not be able to update own user details with existing username', function (done) {
    ...
    _user2.primaryEmail.email = 'user2_email@test.com';
