...
describe('User CRUD tests', function () {
  ...
  it('should be able to register a new user and then update the user using the signup route', function (done) {
    var req = {
      newUser: _user,
      primaryEmail: {
    ...
    agent.post('/api/auth/invite')
      .send(req)
      .expect(200)
      .end(function (inviteErr, inviteRes) {
        // Handle signpu error
        if (inviteErr) {
          return done(inviteErr);
        }
        console.log(inviteRes.body);
